...
if __name__ == '__main__':
    ...
    elif config == 'l2p_core50':
        from configs.l2p.l2p_core50 import get_args_parser
        config_parser = subparser.add_parser('l2p_core50', help='')
    ...
    elif config == 'dualp_core50':
        from configs.dualp.dualp_core50 import get_args_parser
        config_parser = subparser.add_parser('dualp_core50', help='')
    else:
